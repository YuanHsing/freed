{
  "author":"20220606",
  "name": "真的卡影院",
  "url": "https://www.zhendeka.com", //填网站链接
  ...
  "jiequshuzuqian": "class=\"p1 m1", //截取的列表数组的前关键词,截取的关键词有 " 的用 \ 进行转义
  ...
  "bfjiequqian": "空",
  "bfjiequhou": "空",
  "bfjiequshuzuqian": "<div id=\"vlink_", //播放截取的列表数组的前关键词
  "bfjiequshuzuhou": "</ul>", //播放截取的列表数组的后关键词

  "zhuangtaiqian": "<span>", //状态前关键词
  "zhuangtaihou": "</span></dt>", //状态后关键词
  "daoyanqian": "导演：</span>", //导演前关键词
  "daoyanhou": "</dd>", //导演态后关键词
  "zhuyanqian": "主演：</span>", //主演前关键词
  "zhuyanhou": "</dt>", //主演后关键词
  "juqingqian": "介绍：</span>", //剧情前关键词
  "juqinghou": "</div>", //剧情后关键词
